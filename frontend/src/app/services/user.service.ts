...
export class UserService {
  ...
  addToUserList(doramaId: number): Observable<any> {
    return this.http.post<any>(`${this.URL}/user/`, {
      dorama: doramaId,
    });
  }
  removeFromUserList(doramaId: number): Observable<any> {
  ...
  public confirmCom(doramaId: number, body: string): Observable<any>{
    return this.http.post<any>(`${this.URL}/comments/`, {
      body: body, dorama: doramaId
    });
  }
